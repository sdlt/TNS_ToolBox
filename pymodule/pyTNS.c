...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_free_prediction(PyObject *self, PyObject *noarg)
{
...
#else
#  define _cffi_f_free_prediction _cffi_d_free_prediction
#endif

static int _cffi_d_get_prediction(double x0, double x1, int x2, double * x3, double x4, double x5, double x6, double x7, double x8, double x9, double x10, double x11)
{
  return get_prediction(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_get_prediction(PyObject *self, PyObject *args)
{
  double x0;
  double x1;
  int x2;
  ...
  if (!PyArg_UnpackTuple(args, "get_prediction", 12, 12, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = get_prediction(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
#else
#  define _cffi_f_get_prediction _cffi_d_get_prediction
#endif

static int _cffi_d_get_prediction_LL(double x0, double x1, int x2, double * x3, double x4, double x5, double x6, double x7, double x8, double x9)
{
  return get_prediction_LL(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_get_prediction_LL(PyObject *self, PyObject *args)
{
  double x0;
  double x1;
  int x2;
  ...
  if (!PyArg_UnpackTuple(args, "get_prediction_LL", 10, 10, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = get_prediction_LL(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_init_prediction(PyObject *self, PyObject *arg0)
{
  char * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
...
#else
#  define _cffi_f_init_prediction _cffi_d_init_prediction
#endif
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_pyTNS(const void *p[])
{
...
PyInit_pyTNS(void)
{
  return _cffi_init("pyTNS", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initpyTNS(void)
{
  _cffi_init("pyTNS", 0x2601, &_cffi_type_context);
}
#endif
